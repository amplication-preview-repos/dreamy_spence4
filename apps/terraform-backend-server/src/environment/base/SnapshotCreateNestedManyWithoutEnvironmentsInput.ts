...
@InputType()
class SnapshotCreateNestedManyWithoutEnvironmentsInput {
...
export { SnapshotCreateNestedManyWithoutEnvironmentsInput as SnapshotCreateNestedManyWithoutEnvironmentsInput };
